...
- The code is tested with CUDA 12.2.

- All results are based on NVIDIA A100. 

- Set up python environment steps from scratch:
```
...
| StyleGAN2ADA    | Encoder                | DatasetGAN |
| :-------------- | :--------------------: | ---------: |
| 7 Days 22 Hours | 1 Day 11 Hours 44 mins | 36 mins    |
...
### Windows enviorments (not sure to working)
